...
#   brew tap sqliteai/kimi-k3-lean https://github.com/sqliteai/homebrew-kimi-k3-lean
...
#
# This formula is published in the sqliteai/homebrew-kimi-k3-lean tap.
...
class KimiK3Lean < Formula
  ...
  homepage "https://github.com/sqliteai/kimi-k3-lean"
  url "https://github.com/sqliteai/kimi-k3-lean/archive/refs/tags/v0.6.8.tar.gz"
  sha256 "PLACEHOLDER_SHA256"  # updated by the release workflow
  license "Apache-2.0"
  head "https://github.com/sqliteai/kimi-k3-lean.git", branch: "main"
