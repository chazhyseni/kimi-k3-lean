...
$(CLI_BIN): $(CLI_SRC) $(ENGINE_OBJ) $(LIBK3_OBJ) | $(BIN)
	$(CC) $(CFLAGS) $(INCLUDES) $(CLI_SRC) $(ENGINE_OBJ) $(LIBK3_OBJ) -o $@ $(LDFLAGS)

$(LIBK3_SO): $(ENGINE_OBJ) $(LIBK3_OBJ) | $(BIN)
	$(CC) -shared -fPIC $(ENGINE_OBJ) $(LIBK3_OBJ) -o $@ $(LDFLAGS)
